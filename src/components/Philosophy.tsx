    ...
    <section ref={sectionRef} className="relative py-32 md:py-44 overflow-hidden bg-brand-dark">
      ...
      <div className="container-site relative z-10 max-w-4xl">
        ...
        <h2 ref={line2Ref} className="leading-[1.05] mb-10" style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)" }}>
          {w("We match", "font-display font-semibold text-white")}
          <span className="inline-block mr-[0.3em] font-serif font-normal italic text-brand-mint">every method</span>
          {w("to the surface. Hot water where it matters. Soft wash where it counts. And a", "font-display font-semibold text-white")}
          <span className="inline-block mr-[0.3em] font-serif font-normal italic text-brand-blue">maintenance plan</span>
          {w("that keeps Portland weather from winning.", "font-display font-semibold text-white")}
        </h2>
