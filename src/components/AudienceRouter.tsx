        ...
        <div ref={cardsRef} className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto">
          ...
          <div className="relative rounded-[2rem] bg-surface-mint border border-brand-mint/25 overflow-hidden flex flex-col p-8 md:p-10">
            ...
            <div className="relative flex flex-col flex-1">
              ...
              <a
                href="#services"
                className="group/btn self-start inline-flex items-center gap-2 bg-brand-blue text-brand-black font-bold text-sm px-6 py-3 rounded-full hover:bg-brand-darker hover:text-white transition-all duration-300 shadow-[0_0_20px_rgba(98,196,235,0.25)]"
              >
                Explore Residential
                <ArrowRight className="w-4 h-4 transition-transform group-hover/btn:translate-x-0.5" />
              </a>
